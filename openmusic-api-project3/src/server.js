...
const init = async () => {
  ...
  const collaborationsService = new CollaborationsService(cacheService); // Menerapkan fungsi redis
  const playlistsService = new PlaylistsService(collaborationsService, cacheService); // Menerapkan fungsi collaboration dan redis
  const playlistsongService = new PlaylistsongService(collaborationsService, cacheService); // Menerapkan fungsi collaboration dan redis
  ...
  await server.register([
    ...
    },
    {
      plugin: _exports,
      options: {
        ProducerService, // Service Data
        playlistsService, // Mengecek Owner Kepemilikan Playlist
